...
S {}
E {}
T {Simulation Output Folder 6} 340 -470 0 0 0.3 0.3 {}
N -340 -170 -330 -170 {
lab=Vbp}
N -330 -220 -330 -170 {
lab=Vbp}
...
dowhile run <= mc_runs
  ...
  while code <= 16
    ...
    wrdata ~/dev/git/magic-dds/simulations/current_steering_dac/6/ieeeDAC_\{$&run\}.txt code v(D1) v(D2) v(D3) v(D4) v(D5) i(VIin) i(VIdump) v(Vout)
    if code eq 0
      set appendwrite
...
C {/home/madvlsi/dev/git/magic-dds/xschem/other_project_files/opamp_schematic.sym} 1230 -170 0 0 {name=x35}
C {madvlsi/vdd.sym} 1170 -240 0 0 {name=l2 lab=VDD}
C {madvlsi/gnd.sym} 1170 0 0 0 {name=l14 lab=GND}
C {devices/lab_pin.sym} 1020 -380 2 0 {name=p22 sig_type=std_logic lab=Vbn2}
C {devices/lab_pin.sym} 1130 -90 0 0 {name=p28 sig_type=std_logic lab=Vbp2}
C {devices/lab_pin.sym} 1130 -70 0 0 {name=p31 sig_type=std_logic lab=Vcp2}
C {devices/lab_pin.sym} 1130 -50 0 0 {name=p35 sig_type=std_logic lab=Vcn2}
C {devices/lab_pin.sym} 1130 -30 0 0 {name=p36 sig_type=std_logic lab=Vbn2}
C {madvlsi/resistor.sym} 1060 -250 2 0 {name=R1
value=30k
m=1}
C {madvlsi/vsource.sym} 1110 -270 0 0 {name=Vref
value=1.1}
C {madvlsi/gnd.sym} 1110 -240 0 0 {name=l15 lab=GND}
C {madvlsi/resistor.sym} 1170 70 1 0 {name=R2
value=30k
m=1}
C {madvlsi/ammeter1.sym} 990 -190 3 0 {name=VIin}
C {madvlsi/ammeter1.sym} 1020 -150 3 0 {name=VIdump}
C {devices/lab_pin.sym} 1320 -170 2 0 {name=p37 sig_type=std_logic lab=Vout}
