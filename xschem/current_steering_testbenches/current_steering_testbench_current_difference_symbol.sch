...
S {}
E {}
T {Simulation Output Folder 8} 340 -470 0 0 0.3 0.3 {}
N -340 -170 -330 -170 {
lab=Vbp}
N -330 -220 -330 -170 {
lab=Vbp}
...
dowhile run <= mc_runs
  ...
  while code <= 16
    ...
    wrdata ~/dev/git/magic-dds/simulations/current_steering_dac/8/ieeeDAC_\{$&run\}.txt code v(D1) v(D2) v(D3) v(D4) v(D5) i(VIin) i(VIdump)
    if code eq 0
      set appendwrite
...
C {madvlsi/ammeter1.sym} 1380 -260 3 0 {name=VIin}
...
C {madvlsi/vsource.sym} 1450 -180 0 0 {name=V8
value=0.5}
C {madvlsi/gnd.sym} 1450 -150 0 0 {name=l21 lab=GND}
...
C {/home/madvlsi/dev/git/magic-dds/xschem/current_difference_balanced.sym} 1330 -270 0 0 {name=x35}
C {devices/lab_pin.sym} 1180 -150 0 0 {name=p22 sig_type=std_logic lab=Vcn2}
C {devices/lab_pin.sym} 1180 -170 0 0 {name=p28 sig_type=std_logic lab=Vcp2}
C {devices/lab_pin.sym} 1180 -190 0 0 {name=p31 sig_type=std_logic lab=Vbp2}
C {madvlsi/ammeter1.sym} 1060 -240 1 0 {name=VIdump}
