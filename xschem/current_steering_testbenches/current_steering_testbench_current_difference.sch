...
S {}
E {}
T {Simulation Output Folder 5} 340 -470 0 0 0.3 0.3 {}
N -340 -170 -330 -170 {
lab=Vbp}
N -330 -220 -330 -170 {
lab=Vbp}
...
dowhile run <= mc_runs
  ...
  while code <= 16
    ...
    wrdata ~/dev/git/magic-dds/simulations/current_steering_dac/5/ieeeDAC_\{$&run\}.txt code v(D1) v(D2) v(D3) v(D4) v(D5) i(VIin) i(VIdump)
    if code eq 0
      set appendwrite
...
C {madvlsi/vsource.sym} 1470 -90 0 0 {name=V8
value=0.5}
C {madvlsi/gnd.sym} 1470 -60 0 0 {name=l21 lab=GND}
