...
S {}
E {}
T {Simulation Output Folder 1} 580 -380 0 0 0.3 0.3 {}
N 10 -100 10 -80 {
lab=#net1}
N 10 -100 580 -100 {
lab=#net1}
...
dowhile run <= mc_runs
  ...
  while code <= 4
    ...
    wrdata ~/dev/git/magic-dds/simulations/current_steering_dac/1/ieeeDAC_\{$&run\}.txt code v(D1) v(D1b) i(VIin) i(VIdump)
    if code eq 0
      set appendwrite
...
C {/home/madvlsi/dev/git/magic-dds/xschem/other_project_files/inverter.sym} 140 170 0 0 {name=x7}
C {/home/madvlsi/dev/git/magic-dds/xschem/other_project_files/inverter.sym} 300 170 0 0 {name=x8}
C {/home/madvlsi/dev/git/magic-dds/xschem/other_project_files/inverter.sym} 470 170 0 0 {name=x9}
...
C {/home/madvlsi/dev/git/magic-dds/xschem/other_project_files/bias_schematic.sym} -170 0 0 0 {name=x6}
