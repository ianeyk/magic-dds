...
C {madvlsi/isource.sym} -770 140 0 0 {name=I3
value="sin(0 10u \{1/P/128\} 0 0 0)"}
C {madvlsi/gnd.sym} -770 170 0 0 {name=l4 lab=GND}
...
C {madvlsi/gnd.sym} -960 90 0 0 {name=l11 lab=GND}
C {madvlsi/isource.sym} -960 60 0 0 {name=I4
