...
C {devices/iopin.sym} 140 40 1 0 {name=p8 lab=GND2}
C {/home/madvlsi/dev/git/magic-dds/lvs/dummy_current_steering_cell.sym} 120 -30 0 0 {name=x1}
C {madvlsi/gnd.sym} 120 40 0 0 {name=l3 lab=GND}
